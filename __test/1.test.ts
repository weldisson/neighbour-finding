...
const input: any = {
    ...
    "cards": {
        ...
        "1f004e1e-1a07-4441-87f5-35bd09085461": {
            "order": 0,
            "trailId": "7e1f69a8-42f6-42ca-bade-1cd1fd1864cb"
        },
        ...
        "54c44c8e-2ca8-4f38-b6f3-37d204d46883": {
            "order": 0,
            "trailId": "37d78867-0881-449b-a50a-758e23ea2f89"
        },
        ...
        "907e3322-dc2d-472e-bd5c-494e296ebd5f": {
            "order": 0,
            "trailId": "962245ef-5cc7-464f-8616-f33ff71febc1"
        },
...
it('Case 1', () => {
    expect(findNeighbors(input, "7e2ddb03-0567-4c23-b190-cfe81473c4ed"))
    .toEqual(output); 
});